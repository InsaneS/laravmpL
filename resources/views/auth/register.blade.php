...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <p><div class="quote">Register</div></p>
        <br/>
        @if (count($errors) > 0)
        ...
        <form class="form-horizontal" role="form" method="POST" action="{{ url('/auth/register') }}">
            ...
            <p><input type="text" class="form-control" name="name" value="{{ old('name') }}"  placeholder="Nickame"></p>
            <p><input type="email" class="form-control" name="email" value="{{ old('email') }}"  placeholder="E-mail"></p>
            ...
            <p style="font-size: 80%;">Have an account already? <a style="font-size: 140%;" href="/auth/login">Login!</a></p>
